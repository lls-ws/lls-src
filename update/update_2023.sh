...
(OK)Criar metodos para fazer todas as funcionalidades JS do Milho {
...
(OK) Conferir arquivos existentes nos diretorios com os arquivos informados nos arquivos para excluir abaixo {
	
	(ok) Arquivo: modulos/milho/sh/jquery-lls-modulos.txt
	(ok) Arquivo: modulos/milho/sh/compila_milho_js.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-umidade.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-baixamilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-entmilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-saimilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-laudomilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-milho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-tramilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-componentes-milho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-faturamilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-movimentomilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-servicomilho.sh
	(ok) Arquivo: modulos/milho/sh/jquery-lls-sintetizamilho.sh
